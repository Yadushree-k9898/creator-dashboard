...
const BarChart = ({ data, className }) => (
  <div
    className={`h-64 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center ${className}`}
  >
...
const SavedFeeds = ({ feedStats }) => {
  ...
  // Safely default to empty arrays if these props are missing
  const interactionData = [
  ...
  const sourceData =
    Array.isArray(feedStats.postSourceDistribution) && feedStats.postSourceDistribution.length
  ...
  const dailyData =
    Array.isArray(feedStats.dailyInteractions) && feedStats.dailyInteractions.length
              ...
              <div className="bg-primary/5 p-4 rounded-lg shadow-sm group hover:shadow-md hover:bg-primary/10 transition-all">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                      {interactionData[0].value.toLocaleString()}
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-50 dark:bg-rose-900/20 p-4 rounded-lg shadow-sm group hover:shadow-md hover:bg-rose-100 dark:hover:bg-rose-900/30 transition-all">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <h3 className="text-xl font-bold text-rose-900 dark:text-rose-100">
                      {interactionData[1].value.toLocaleString()}
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg shadow-sm group hover:shadow-md hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-all">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <h3 className="text-xl font-bold text-amber-900 dark:text-amber-100">
                      {interactionData[2].value.toLocaleString()}
                    </h3>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    {dailyData.map((item, idx) => (
                      ...
                      >
                        ...
                        <td className="text-right py-2 text-rose-500">
                          {item.Reported}
                        </td>
