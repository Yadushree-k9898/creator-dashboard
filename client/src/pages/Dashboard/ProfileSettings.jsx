...
import axios from "axios"
import { toast } from "react-hot-toast"
import { User, Mail, FileText, CreditCard, CheckCircle, AlertTriangle } from "lucide-react"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Tell us about yourself"
              />
              <p className="text-xs text-gray-500 dark:text-gray-400">Your bio will be shown on your public profile</p>
            </div>
